...
if aienv == None:
     openai.api_key = "SK-6I5YG1YVJX9WNIJPBKMZT3BLBKFJQZUEIXTLJPB01WE2UQG0"
else:
...
if tgenv == None:
     tgkey = "6373863791:AAHkOBcWSnhlO98V9dagkSME9A8J3O3RNJk"
else:
    tgkey = tgenv
print(tgenv)
...
qcache = None
chat_log = None
botname = 'shaddad chat_test_gpt'
username = '@Shaddsaeebot'
